...
public class Header extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dashboard/icon/menu.png"))); // NOI18N

        pic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dashboard/icon/profile.jpg"))); // NOI18N
        ...
        buttonBadges1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dashboard/icon/notification.png"))); // NOI18N
        buttonBadges1.setBadges(12);

        buttonBadges2.setForeground(new java.awt.Color(63, 178, 232));
        buttonBadges2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dashboard/icon/message.png"))); // NOI18N
