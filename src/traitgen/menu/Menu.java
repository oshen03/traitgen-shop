package traitgen.menu;

import traitgen.menu.mode.LightDarkMode;
...
import traitgen.menu.mode.ToolBarAccentColor;
...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"Dashboard"},
        {"~Basic~"},
        {"Panels", "Customer", "GRN", "Inventory", "HR Panel", "Repair", "Sales"},
        {"Employee"},
        {"Customer"},
        {"~GRN~"},
        {"History", "Salary Payment", "Invoice history", "Grn history"},
        {"~OTHER~"},
        {"Reports", "All"},
        {"Charts", "All"},
        {"Logout"}
    ...
    private final String headerName = "Computer Shop";
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/traitgen/icon/png/logo.png")));
